...
$message = "Hello  '$name' you are sucessfully registred for event '$event_name' Best wishes from Sport Hub Team";

$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";

// More headers
$headers .= 'From: <shobhit.khurana2015@gmail.com>' . "\r\n";
$headers .= 'Cc: shobhit.19bce7475@vitap.ac.in' . "\r\n";
